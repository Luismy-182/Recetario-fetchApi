...
function iniciarApp(){
 ...
 if(seleccionarCategorias){
    seleccionarCategorias.addEventListener('change', seleccionarCategoria);
    obtenerCategorias()
 }
...
function mostrarRecetas(recetas=[]){
    ...
    recetas.forEach(receta=>{
        ...
        recetaImagen.alt=`Imagen de tu receta ${strMeal ?? receta.titulo}`;
...
function mostrarRecetaModal(receta){
    ...
    modalBody.appendChild(listGroup); //inyecta el cuerpo con los ingredientes y cant
   ...
   if(existeStorage(idMeal)){
    ...
    btnFavorito.textContent='Guardar Favorito'; /********COMO REACT******** */
    ...
    return;
        ...
        btnFavorito.textContent='Eliminar favorito'; /*********COMO react ******** */
